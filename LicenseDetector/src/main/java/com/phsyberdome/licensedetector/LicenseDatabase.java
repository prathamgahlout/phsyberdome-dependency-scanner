...
public class LicenseDatabase {
    ...
    */
    ...
    public LicenseDatabase(Path cloneLocation, String licenseDataUrl) {
    ...
    private void downloadLicenseListData(){
        ...
        Path pathToLicenseList = this.cloneLocation.resolve("licenses.json");
        String urlToLicenseData = this.licenseDataUrl + "licenses.json";
        try {
    ...
    public void loadLicenses() {
        ...
        while(it.hasNext()) {
            ...
            String urlToDetail = this.licenseDataUrl + id + ".json";
            Path pathToLicenseDetailPath = this.cloneLocation.resolve(id+".json");
